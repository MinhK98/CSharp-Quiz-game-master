...
namespace App__Beta_
{
    public partial class Normal : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                conn.Open(); // Kết nối           
                idem = int.Parse(label21.Text.ToString());
                iscore = int.Parse(label17.Text.ToString());
                inext = int.Parse(label16.Text.ToString());
                label16.Text = inext.ToString();

                string d_a = label1.Text;
                string d_b = label2.Text;
                string d_c = label4.Text;
                string d_d = label3.Text;
                string stt = label20.Text;
                string cauhoi = richTextBox1.Text;

                string sql = "SELECT * FROM NORMAL_QUESTION where STT = '"+label21.Text.ToString()+"'";
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                int idem = int.Parse(label21.Text.ToString());

                string sql2 = "select *from NORMAL_QUESTION where STT = '" + stt + "' and DAPAN_DUNG ='" + kt + "'";
                ...
                if (dta.Read() == true)
                {
                    ...
                    idem = rd.Next(1,30);
                    label21.Text = idem.ToString(); // Gán biến idem vào ô label21
                    inext = inext + 1;
                    label16.Text = inext.ToString();
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                conn.Open();
                string sql3 = "UPDATE NGUOIDUNG SET TRUNGBINH = @TRUNGBINH WHERE MATKHAU = @MATKHAU";
                SqlCommand cmd2 = new SqlCommand(sql3, conn);
                cmd2.Parameters.AddWithValue("@TRUNGBINH", label17.Text);
